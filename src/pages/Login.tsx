        ...
        <div className="relative z-10 flex flex-col h-full max-w-xl mx-auto md:mx-0 w-full">
          ...
          >
            <h1 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
              Welcome back to <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7C3AED] to-[#41E5FF]">Smarter Studying</span>
            </h1>
            <p className="text-lg text-secondary-text leading-relaxed max-w-md">
              Log in to access your intelligent workspace. Pick up right where you left off with your notes, flashcards, and AI tutor.
            </p>
          </motion.div>
      ...
      <div className="w-full md:w-1/2 lg:w-[45%] p-6 md:p-12 lg:p-16 flex items-center justify-center relative z-20">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-secondary-text text-sm mb-8">Log in to your account to continue.</p>
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex justify-end mt-[-8px]">
                <Link to="/forgot-password" className="text-xs text-[#41E5FF] hover:text-primary-text transition-colors">
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="mt-8 flex flex-col items-center gap-5 text-sm">
              <p className="text-secondary-text">
                Don't have an account? <Link to="/signup" className="text-[#41E5FF] hover:text-primary-text transition-colors font-medium relative after:absolute after:-bottom-0.5 after:left-0 after:w-full after:h-[1px] after:bg-[#41E5FF]/50 hover:after:bg-white/80">Sign Up</Link>
              </p>
            </div>
